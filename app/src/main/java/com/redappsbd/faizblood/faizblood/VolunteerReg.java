...
public class VolunteerReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.expertitbd.com/Expert-Apps/Faiz-Blood/volunteer_registration.php");
        ...
        webView.setWebViewClient(new WebViewClient()
        {
            ...
            public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(VolunteerReg.this).create();
